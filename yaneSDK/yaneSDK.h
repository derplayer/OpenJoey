...
#include	"Multimedia/index.h"		//	Sound,Movie,CDDA
#include	"Timer/index.h"				//	Timing
#include	"Thread/index.h"			//	Threading
#include	"Window/index.h"			//	Window
#include	"Input/index.h"				//	Input
#include	"Auxiliary/index.h"			//	Auxiliary
#include	"Math/index.h"				//	Mathematics
